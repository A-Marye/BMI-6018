...
def wrong_add_function(arg1,arg2):
   ...
   while arg1_index < len(arg1):
      ...
      message = f"The output is {arg_2_sum}, the correct answer is supposed to be: {sum([arg1[arg1_index]+ arg2[arg1_index]])}"
      print(message)
...
def exception_add_function(arg1, arg2):
    try:
        ...
        print("Your input argument [1 or 2] at element [n] is not of the expected type.")
...
def correction_add_function(arg1, arg2):
    try:
        ...
        new_arg_1 = [str(i) for i in arg1]
        new_arg_2 = [str(i) for i in arg2]
        new_result = wrong_add_function(new_arg_1, new_arg_2)
        return new_result
